 ...
 * @since 1.0.0
 */
class Main_Image_Field extends Image_Field {
	...
	public function get_title() {
		return __( 'Main Image Field', 'acf-frontend-form-element' );
	}
