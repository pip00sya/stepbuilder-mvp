 ...
 * @since 1.0.0
 */
class Product_Excerpt_Field extends Textarea_Field {
	...
	public function get_name() {
		return 'fea_product_excerpt_field';
	}
	...
	public function get_title() {
		return __( 'Product Short Description Field', 'acf-frontend-form-element' );
	}
	...
	protected function get_field_data( $field ) {
		...
		$field['type'] = 'product_short_description';
		return $field;
	}
