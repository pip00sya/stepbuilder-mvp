 ...
 * @since 1.0.0
 */
class Product_Title_Field extends Text_Field {
	...
	public function get_name() {
		return 'fea_product_title_field';
	}
	...
	public function get_title() {
		return __( 'Product Title Field', 'acf-frontend-form-element' );
	}
