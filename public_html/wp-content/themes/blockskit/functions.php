...
define( 'BLOCKSKIT_URL', trailingslashit( get_template_directory_uri() ) );
...
function blockskit_scripts() {
	$version = wp_get_theme( 'blockskit' )->get( 'Version' );
	// Stylesheet
	wp_enqueue_style( 'blockskit-styles', get_theme_file_uri( '/style.css' ), array(), $version );
	wp_enqueue_style( 'blockskit-animate', get_template_directory_uri() . '/assets/css/animate.css', array(), $version, 'all' );

	if ( file_exists( get_template_directory() . '/assets/css/theme-style.css' ) ) {
		wp_enqueue_style( 'blockskit-theme-style', get_template_directory_uri() . '/assets/css/theme-style.css',  array(), $version );
	}
	...
	// Scripts
	$deps = array( 'jquery' );
	wp_enqueue_script( 'blockskit-animate', get_template_directory_uri() . '/assets/js/animate.min.js', $deps, $version );
 ...
 */
function blockskit_block_assets()
{
    wp_enqueue_style( 'blockskit-blocks-style', get_template_directory_uri() . '/assets/css/blocks.css' );
}
add_action( 'enqueue_block_assets', 'blockskit_block_assets' );
 ...
 */
add_filter( 'uagb_enable_redirect_activation', 'blockskit_disable_spectra_redirection' );
function blockskit_disable_spectra_redirection(){
  	return false;
}
