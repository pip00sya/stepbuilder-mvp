...
jQuery(function ($) {
  ...
  $(document).on('blockskitSlideChangeTransitionStart', function () {
  ...
  function blockskit_photography_slider_animation(selector) {
  ...
  $(document).on('blockskitSlideinit', function () {
    var observer = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          blockskit_photography_slider_animation('.swiper-slide-active');
          return;
        }
      });
    });
    observer.observe(document.querySelector('.swiper-wrapper'));
  }); // blockskit_photography_slider_animation('.swiper-slide:first-child');

  $(document).on('blockskitSlideChangeTransitionEnd', function () {
    blockskit_photography_slider_animation('.swiper-slide-active');
  });
});