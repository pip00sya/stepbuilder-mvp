...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--xx-large);padding-bottom:var(--wp--preset--spacing--xx-large)"><!-- wp:post-title {"textAlign":"center","__woocommerceNamespace":"woocommerce/product-query/product-title"} /--></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'You may be interested in…', 'blockskit' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php esc_html_e( 'Your cart is currently empty!', 'blockskit' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><a href="<?php echo esc_url( home_url( '/shop' ) ); ?>"><?php esc_html_e( 'Browse store', 'blockskit' ); ?></a></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'New in store', 'blockskit' ); ?></h2>
<!-- /wp:heading -->
